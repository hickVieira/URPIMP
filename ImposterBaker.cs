...
namespace GutEngine.Editor
{
    ...
    public class ImposterBaker : MonoBehaviour
    {
        ...
        void CreateImposterAssets(RenderTexture albedoPackRT, RenderTexture normalPackRT)
        {
            ...
            // mesh
            MeshRenderer meshRenderer = gameObject.TryGetAddComponent<MeshRenderer>();
            MeshFilter meshFilter = gameObject.TryGetAddComponent<MeshFilter>();
